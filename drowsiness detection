...
mixer.init()
sound = mixer.Sound(r'C:\Users\BIO-s\OneDrive\Desktop\ML CLASS\CLASS\Drowsiness detection\alarm.wav')
...
model = load_model(r'C:\Users\BIO-s\OneDrive\Desktop\ML CLASS\CLASS\Drowsiness detection\models\cnnCat2.h5')
path = os.getcwd()
